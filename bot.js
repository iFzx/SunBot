...
client.on('ready', () => {
    ...
    console.log(`Channels : [ " ${client.channels.size} " ]`);
     client.user.setActivity("The Sun. | +help",{type: 'WATCHING'})
...
client.on("message", message => {
    ...
    var rebel = `
      **=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=**
             ...
             ** ${prefix}zalg **    |    يزخرف لك كلمة او جملة
             ...
             ** ${prefix}topinvite **    |    متصدري الدعوات
   ...
   client.on("message", message => {
    ...
    var rebel = `
             ...
             ** ${prefix}clear2 <numbr> **    |    مسح الشات بعدد
             ...
             ** ${prefix}alarmed **    |    لانشاء روم مؤقت
             ...
             ** ${prefix}alljoin **    |    سحب الكل إلى رومك الصوتي
